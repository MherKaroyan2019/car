...
<?php include 'header.php' ?>
    <div class="main-content">
        <div class="car">
            <div class="parametrs">
                <div class="images" data-count="0" data-image-names="<?php echo $r["imgNames"] ?>" style="background-image: url('addimages/<?php echo explode(",", $r['imgNames'])[0]; ?>')">
                    <div class="left-arrow" style="background-image: url('img/left-arrow.png')" onclick="previousimg()"></div>
                    <div class="right-arrow" style="background-image: url('img/right-arrow.png')" onclick="nextimg()"></div>
                </div>
                <div class="car-info">
                    <div class="main-info">
                    ...
                    <div class="info-part">
                        <h3>Նկարագիր</h3>
                        <pre><?php echo $r["description"]; ?></pre>
                    </div>
                </div>
            </div>
            <div>
                ...
                <div class="other">
                    ...
                    ?>  
                        <a href="product.php?id=<?php echo $r2["id"] ?>">
                            <div class="other-car">
                                <img src="addimages/<?php echo $imgname ?>">
